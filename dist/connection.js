...
var Connection = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        connection.onerror = function (error) { return _this.onError(error); };
                        connection.onclose = function (data) { return _this.onClose(data); };
                        return [2 /*return*/];
                }
            });
        });
    ...
    Connection.prototype.send = function (content) {
        if (!this.connection) {
            console.error("Connection not started. Call 'connect' first!");
            return -1;
        }
        var id = this.getNextId();
        this.connection.send(JSON.stringify({ id: id, content: content }));
        return id;
    };
